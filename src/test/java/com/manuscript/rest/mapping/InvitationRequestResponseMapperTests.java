...
import com.manuscript.rest.mapping.response.InvitationRequestResponseMapperImpl;
...
public class InvitationRequestResponseMapperTests {
    private final InvitationRequestResponseMapperImpl invitationRequestResponseMapper = new InvitationRequestResponseMapperImpl();
    ...
    public void modelToRest_success() {
        //act
        InvitationRequestResponse invitationRequestRequest = invitationRequestResponseMapper.modelToRest(invitationRequestModel);

        //assert
        assertEquals(this.invitationRequestResponse, invitationRequestRequest);
    }
    ...
    public void restToModel_success() {
        //act
        InvitationRequestModel invitationRequestModel = invitationRequestResponseMapper.restToModel(invitationRequestResponse);
